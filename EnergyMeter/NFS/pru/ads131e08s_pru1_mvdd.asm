...
; Channel 1-8: PGA gain 1x, normal
    ADS_WRITE_REG   CH1SET, CH_GAIN_1 + CH_VDD
    ADS_WRITE_REG   CH2SET, CH_GAIN_1 + CH_VDD  ;CH_NORMAL
    ADS_WRITE_REG   CH3SET, CH_GAIN_1 + CH_VDD ;CH_NORMAL
    ADS_WRITE_REG   CH4SET, CH_GAIN_1 + CH_VDD ;CH_NORMAL
    ADS_WRITE_REG   CH5SET, CH_GAIN_1 + CH_VDD ;CH_NORMAL
    ADS_WRITE_REG   CH6SET, CH_GAIN_1 + CH_VDD ;CH_NORMAL
    ADS_WRITE_REG   CH7SET, CH_GAIN_1 + CH_VDD ;CH_NORMAL
    ADS_WRITE_REG   CH8SET, CH_GAIN_1 + CH_VDD ;CH_NORMAL
